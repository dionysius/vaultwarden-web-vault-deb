...
For using apt they are available on [apt.crunchy.run](https://apt.crunchy.run/vaultwarden). Refer to the installation instructions there on how to setup the apt source. [vaultwarden-deb](https://github.com/dionysius/vaultwarden-deb) is also available in this repo.
