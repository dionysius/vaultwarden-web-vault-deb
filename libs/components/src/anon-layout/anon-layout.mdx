...
developer simply uses the AnonLayout**Wrapper**Component in `oss-routing.module.ts` (for Web, for
...
Routes that use the AnonLayout**Wrapper**Component can take several unique data properties defined
